...
class DatasetCOCO2PASCAL(Dataset):
    ...
    def build_class_ids(self):
        ...
        class_ids_val = cls_ids[self.fold]
        return class_ids_val

    def build_img_metadata(self):

        def read_metadata(split, fold_id):
            fold_n_metadata = os.path.join('data/splits/lists/coco2pascal/fss_list/%s/data_list_%d.txt' % (split, fold_id))
    ...
    def build_img_metadata_classwise(self):
        if self.split == 'trn':
            ...
            split = 'val'
        fold_n_subclsdata = os.path.join('data/splits/lists/coco2pascal/fss_list/%s/sub_class_file_list_%d.txt' % (split, self.fold))
